...
class BedPlaceView: UIView {

    lazy var yourPlaceImage = UIImageView(image: #imageLiteral(resourceName: "bed-17"))
    lazy var freePlaceImage = UIImageView(image: #imageLiteral(resourceName: "bed-16"))
    lazy var reservePlaceImage = UIImageView(image: #imageLiteral(resourceName: "bed-12"))
    lazy var processPlaceImage = UIImageView(image: #imageLiteral(resourceName: "bed-15"))
