...
class MainViewController: BaseViewController {
    ...
    lazy var findButton: DefaultButton = {
        ...
        button.setTitle(localized(text: "tickFound"), for: .normal)
    ...
    @objc func tapFind() -> Void {
        ...
        // vc set
        let vc = SearchResultViewController(from_city_id: fromCityID!,
                                            to_city_id: toCityID!,
                                            date: onlyDate!)
...
extension MainViewController: ConvenienceSimpleViewControllerDelegate {
